...
const API_URL="https://script.google.com/macros/s/AKfycbyvDFs6hUu-jSEwOCk9s0exPJXGtCtMc3LiADj_0jZFsyuLSmTHskmf3W-b9H1o-QBK/exec";
...
msg.textContent=
"Deposit request submitted. Waiting for admin verification.";
...
function pollDeposit(requestId){
...
await fetch(
API_URL+
"?action=depositStatus&requestId="+
...
function pollWithdrawal(requestId){
